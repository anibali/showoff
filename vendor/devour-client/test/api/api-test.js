...
describe('JsonApi', () => {
  var jsonApi = null
  beforeEach(() => {
    jsonApi = new JsonApi({apiUrl: 'http://myapi.com', pluralize})
  })
  ...
  describe('urlFor, pathFor and path builders', () => {
    ...
    context('with collection and resource trailing slashes', () => {
      beforeEach(() => {
        jsonApi = new JsonApi({apiUrl: 'http://myapi.com', pluralize, trailingSlash: {collection: true, resource: true}})
      })
    ...
    context('with only collection trailing slashes', () => {
      beforeEach(() => {
        jsonApi = new JsonApi({apiUrl: 'http://myapi.com', pluralize, trailingSlash: {collection: true, resource: false}})
      })
    ...
    context('with only resource trailing slashes', () => {
      beforeEach(() => {
        jsonApi = new JsonApi({apiUrl: 'http://myapi.com', pluralize, trailingSlash: {collection: false, resource: true}})
      })
  ...
  describe('Builder pattern for route construction', () => {
    ...
    it('should respect resetBuilderOnCall when it is disabled', (done) => {
      jsonApi = new JsonApi({apiUrl: 'http://myapi.com', pluralize, resetBuilderOnCall: false})
      let inspectorMiddleware = {
        name: 'inspector-middleware',
        req: (payload) => {
          expect(payload.req.method).to.be.eql('GET')
